Public Class VideoCategory
   ...
   Public Function Copy() As VideoCategory
      Return New VideoCategory With {.CategoryID = Me.CategoryID, _
                                        .AddedDate = Me.AddedDate, _
                                        .AddedBy = Me.AddedBy, _
                                        .Title = Me.Title, _
                                        .Description = Me.Description, _
                                        .ImageUrl = Me.ImageUrl, _
                                        .Importance = Me.Importance, _
                                        .ParentCategoryID = Me.ParentCategoryID, _
                                        .Slug = Me.Slug}
   End Function
End Class
