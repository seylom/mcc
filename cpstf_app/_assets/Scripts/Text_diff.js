...
function XinDiffEngine(createMap) {
    ...
    this.doDiff = function() {
        ...
        return this.diff(begin0, end0, begin1, end1, this.createMap(true), -1).pack(new XinDiffLinks
());
    }
    ...
    this.diff = function(begin0, end0, begin1, end1, cache, minLinks) {
        ...
        for (; ; ) {
            ...
            overlap1 = xindiffMatch(element0, this.index[1], begin1, end1);
            if (overlap1 == null) {
                ++begin0;
                continue;
            }

            overlap0 = xindiffMatch(element1, this.index[0], begin0, end0);
            if (overlap0 == null) {
                ++begin1;
                continue;
            }
        ...
        if ((overlap0 - begin0) <= (overlap1 - begin1)) {
            ...
            if (links1.count > (end0 - overlap0)) {
                ...
                var links0 = this.diff(overlap0, end0, begin1, end1, cache, Math.max(minLinks, link1s.count));
...
function XinDiffOutput(createMap) {
    this.createMap = createMap;
    this.spaces = [];
    this.html = [];
