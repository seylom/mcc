...
<Table(Name:="dbo.aspnet_Membership")>  _
Partial Public Class aspnet_Membership
	...
	<Column(Storage:="_ApplicationId", DbType:="UniqueIdentifier NOT NULL")>  _
	...
	<Column(Storage:="_Password", DbType:="NVarChar(128) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_PasswordFormat", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_PasswordSalt", DbType:="NVarChar(128) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_MobilePIN", DbType:="NVarChar(16)")>  _
	...
	<Column(Storage:="_Email", DbType:="NVarChar(256)")>  _
	...
	<Column(Storage:="_LoweredEmail", DbType:="NVarChar(256)")>  _
	...
	<Column(Storage:="_PasswordQuestion", DbType:="NVarChar(256)")>  _
	...
	<Column(Storage:="_PasswordAnswer", DbType:="NVarChar(128)")>  _
	...
	<Column(Storage:="_IsLockedOut", DbType:="Bit NOT NULL")>  _
	...
	<Column(Storage:="_LastLoginDate", DbType:="DateTime NOT NULL")>  _
	...
	<Column(Storage:="_LastPasswordChangedDate", DbType:="DateTime NOT NULL")>  _
	...
	<Column(Storage:="_LastLockoutDate", DbType:="DateTime NOT NULL")>  _
	...
	<Column(Storage:="_FailedPasswordAttemptCount", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_FailedPasswordAttemptWindowStart", DbType:="DateTime NOT NULL")>  _
	...
	<Column(Storage:="_FailedPasswordAnswerAttemptCount", DbType:="Int NOT NULL")>  _
	...
	<Column(Storage:="_FailedPasswordAnswerAttemptWindowStart", DbType:="DateTime NOT NULL")>  _
	...
	<Association(Name:="aspnet_User_aspnet_Membership", Storage:="_aspnet_User", ThisKey:="UserId", OtherKey:="UserId", IsForeignKey:=true)>  _
...
<Table(Name:="dbo.aspnet_Profile")>  _
Partial Public Class aspnet_Profile
	...
	<Column(Storage:="_PropertyNames", DbType:="NText NOT NULL", CanBeNull:=false, UpdateCheck:=UpdateCheck.Never)>  _
	...
	<Column(Storage:="_PropertyValuesString", DbType:="NText NOT NULL", CanBeNull:=false, UpdateCheck:=UpdateCheck.Never)>  _
	...
	<Column(Storage:="_PropertyValuesBinary", DbType:="Image NOT NULL", CanBeNull:=false, UpdateCheck:=UpdateCheck.Never)>  _
	...
	<Column(Storage:="_LastUpdatedDate", DbType:="DateTime NOT NULL")>  _
	...
	<Association(Name:="aspnet_User_aspnet_Profile", Storage:="_aspnet_User", ThisKey:="UserId", OtherKey:="UserId", IsForeignKey:=true)>  _
	Public Property aspnet_User() As aspnet_User
		Get
			Return Me._aspnet_User.Entity
		End Get
...
Partial Public Class aspnet_Role
	...
	<Column(Storage:="_RoleId", DbType:="UniqueIdentifier NOT NULL", IsPrimaryKey:=true)>  _
	...
	<Column(Storage:="_RoleName", DbType:="NVarChar(256) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_LoweredRoleName", DbType:="NVarChar(256) NOT NULL", CanBeNull:=false)>  _
...
Partial Public Class aspnet_User
	...
	<Column(Storage:="_UserName", DbType:="NVarChar(256) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_LoweredUserName", DbType:="NVarChar(256) NOT NULL", CanBeNull:=false)>  _
	...
	<Column(Storage:="_MobileAlias", DbType:="NVarChar(16)")>  _
	...
	<Column(Storage:="_IsAnonymous", DbType:="Bit NOT NULL")>  _
	...
	<Column(Storage:="_LastActivityDate", DbType:="DateTime NOT NULL")>  _
	...
	<Column(Storage:="_isActivated", DbType:="Bit NOT NULL")>  _
	...
	<Association(Name:="aspnet_User_aspnet_Membership", Storage:="_aspnet_Membership", ThisKey:="UserId", OtherKey:="UserId", IsUnique:=true, IsForeignKey:=false)>  _
	...
	<Association(Name:="aspnet_User_aspnet_Profile", Storage:="_aspnet_Profile", ThisKey:="UserId", OtherKey:="UserId", IsUnique:=true, IsForeignKey:=false)>  _
