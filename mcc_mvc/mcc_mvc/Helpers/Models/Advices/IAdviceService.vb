...
Namespace Advices
   Public Interface IAdviceService
      ...
      ''' </summary>
      Function InsertAdvice(ByVal title As String, ByVal Abstract As String, ByVal body As String, ByVal approved As Boolean, ByVal listed As Boolean, ByVal commentsEnabled As Boolean, ByVal onlyForMembers As Boolean, ByVal tags As String) As Boolean
      Function UpdateAdvice(ByVal AdviceId As Integer, ByVal title As String, ByVal Abstract As String, ByVal body As String, ByVal approved As Boolean, ByVal listed As Boolean, ByVal commentsEnabled As Boolean, ByVal onlyForMembers As Boolean, ByVal tags As String) As Boolean
      Function DeleteAdvice(ByVal AdviceId As Integer) As Boolean
      Function ApproveAdvice(ByVal AdviceId As Integer) As Boolean
      ...
      Function IncrementViewCount(ByVal AdviceId As Integer) As Boolean
      Function RateAdvice(ByVal adviceId As Integer, ByVal rating As Integer) As Boolean
      ''' <summary>
      ''' Vote up advice
      ''' </summary>
