...
Namespace Articles
   Public Interface IArticleService
      ...
      ''' </summary>
      Function InsertArticle(ByVal title As String, ByVal Abstract As String, ByVal body As String, ByVal country As String, ByVal state As String, ByVal city As String, ByVal releaseDate As DateTime, ByVal expireDate As DateTime, ByVal approved As Boolean, ByVal listed As Boolean, ByVal commentsEnabled As Boolean, ByVal onlyForMembers As Boolean, ByVal ImageNewsUrl As String, ByVal ImageIconUrl As String, ByVal tags As String, ByVal videoId As Integer, ByVal pollId As Integer, ByVal status As Integer, ByVal imageId As Integer) As Boolean
      Function UpdateArticle(ByVal articleId As Integer, ByVal title As String, ByVal Abstract As String, ByVal body As String, ByVal country As String, ByVal state As String, ByVal city As String, ByVal releaseDate As DateTime, ByVal expireDate As DateTime, ByVal approved As Boolean, ByVal listed As Boolean, ByVal commentsEnabled As Boolean, ByVal onlyForMembers As Boolean, ByVal ImageNewsUrl As String, ByVal ImageIconUrl As String, ByVal tags As String, ByVal videoId As Integer, ByVal pollId As Integer, ByVal status As Integer, ByVal imageId As Integer) As Boolean
      Function DeleteArticles(ByVal ArticleId As Integer()) As Boolean
      Function DeleteArticle(ByVal ArticleId As Integer) As Boolean
      Function ApproveArticle(ByVal articleId As Integer) As Boolean
      ...
      Function IncrementViewCount(ByVal articleId As Integer) As Boolean
      Function RateArticle(ByVal articleId As Integer, ByVal rating As Integer) As Boolean
      ...
      Function UpdateArticleStatus(ByVal id As Integer) As Boolean
      Function UpdateArticleStatus(ByVal id As Integer, ByVal st As mccEnum.Status)
