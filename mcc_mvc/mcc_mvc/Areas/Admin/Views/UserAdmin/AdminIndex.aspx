...
<asp:Content ID="Content2" ContentPlaceHolderID="mainSiteContent" runat="Server">
   ...
   <table class="edit-info">
      ...
      <tr>
         ...
         <td class="left">
            <asp:Literal ID="lblTotalRegisteredUsers" runat="server"></asp:Literal>
         </td>
      </tr>
      <tr>
         <td class="right">
   ...
   <table class="edit-info datatable" style="margin-top: 10px;">
      ...
      <tbody>
         ...
         <tr id='item_<%= it.UserID  %>' class='<%= IIF(idx Mod 2 = 0,"even","odd") %>'>
            ...
            <td>
               <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%= "/Admin/Index/EditUser.aspx?Username=" & it.Username  %>'
                  ToolTip="Edit User">Edit</asp:HyperLink>
            </td>
         </tr>
         <% idx += 1%>
         <%Next%>
