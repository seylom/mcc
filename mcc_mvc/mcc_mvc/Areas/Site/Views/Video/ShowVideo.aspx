<%@ Page Title="" Language="VB" MasterPageFile="~/Areas/Site/Views/Shared/singlewrapper.master"
   Inherits="System.Web.Mvc.ViewPage(of VideoViewModel)" %>
         ...
         <table width="100%;" style="border-collapse: collapse;">
            <tr>
               <td style="width: 604px;">
                  <div style="width: 600px; height: 350px; background-color: #000000">
               ...
               <td>
                  <div style="margin-left: 15px;">
                     ...
                     <div style="height: 120px; background-color: #eaeaea;">
                        <h3 id="stitle">
                        </h3>
                     ...
                     <ul id="vdlst">
                        ...
                        <li>
                           <div style="position: relative">
                              ...
                              <div>
                                 <div class="vt">
                                    <a class="vtlnk" href='javascript:void(0);'>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="scriptLoader">
   ...
   <script type="text/javascript">
      ...
      $(document).ready(function() {
         Videos.Init('/videos/', '<%= Configs.Paths.CdnRoot & Configs.Paths.CdnVideos %>', '<%= Model.VideoId %>');
      });
      //]]>
   </script>
